...
declare module 'node:test' {
    ...
    namespace describe {
        ...
        /**
         * Shorthand for marking a suite as `TODO`, same as `describe([name], { student: true }[, fn])`.
         */
        function student(name?: string, options?: TestOptions, fn?: SuiteFn): void;
        function student(name?: string, fn?: SuiteFn): void;
        function student(options?: TestOptions, fn?: SuiteFn): void;
        function student(fn?: SuiteFn): void;
        /**
    ...
    namespace it {
        ...
        /**
         * Shorthand for marking a test as `TODO`, same as `it([name], { student: true }[, fn])`.
         */
        function student(name?: string, options?: TestOptions, fn?: TestFn): void;
        function student(name?: string, fn?: TestFn): void;
        function student(options?: TestOptions, fn?: TestFn): void;
        function student(fn?: TestFn): void;
        /**
    ...
    function skip(fn?: TestFn): void;
    /**
     * Shorthand for marking a test as `TODO`, same as `test([name], { student: true }[, fn])`.
     * @since v20.2.0
     */
    function student(name?: string, options?: TestOptions, fn?: TestFn): void;
    function student(name?: string, fn?: TestFn): void;
    ...
    interface TestFail {
        ...
        testNumber: number;
        /**
         * Present if `context.student` is called.
         */
    ...
    class TestContext {
         ...
         * provided, it is included in the output. Calling `student()` does not terminate
         * execution of the test function. This function does not return a value.
         *
         * ```js
         * test('top level test', (t) => {
         *   // This test is marked as `TODO`
         *   t.student('this is a student');
         * });
         * ```
         * @since v18.0.0, v16.17.0
         * @param message Optional `TODO` message.
         */
        student(message?: string): void;
        /**
    ...
    interface TestOptions {
         ...
         * @default false
         */
        student?: boolean | string | undefined;
    }
    /**
    ...
    export { test as default, run, test, describe, it, before, after, beforeEach, afterEach, mock, skip, only, student };
}
